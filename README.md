...
Para el experimento de Eye Tracking sobre el Caso B (GoikoMes), hemos simulado el uso de GazeRecorder (o herramientas similares) con la pantalla "Votaciones del mes".
...
El proceso de desarrollo de Bold Burger siguiendo esta metodología UX ha sido una experiencia globalmente positiva y muy enriquecedora, aunque exigente. Tras finalizar todas las fases del proyecto, destacamos las siguientes reflexiones como equipo:
- **Diversidad metodológica y referencias**: Valoramos muy positivamente haber puesto en práctica tantas metodologías diferentes a lo largo del curso. Nos ha dado una visión muy amplia de las distintas formas de abordar el diseño de interfaces. Además, el Hall of Fame ha sido un recurso invaluable; tener ejemplos de referencia nos ayudó enormemente a desencallarnos cuando no teníamos clara la ejecución técnica de alguna fase, todo ello sin que sintiéramos limitada nuestra propia libertad creativa.
- **Dinámica de trabajo**: El trabajo en equipo ha sido fluido y productivo. No hemos tenido desacuerdos significativos, lo que ha facilitado la toma de decisiones ágil y una convivencia excelente en el desarrollo del proyecto.
- **Carga de trabajo y tamaño de los grupos**: Precisamente por la profundidad y cantidad de metodologías aplicadas, las prácticas han requerido una inversión de tiempo altísima. Consideramos que ampliar los grupos de trabajo a 3 o 4 personas sería una gran mejora para futuros cursos. Esto permitiría diluir la carga de trabajo operativa, manteniendo al mismo tiempo el aprendizaje cruzado donde todos los miembros tocan un poco de cada fase.
- **El reto del Diseño Atómico**: A nivel teórico, consideramos que el Diseño Atómico es un concepto fundamental y muy útil de conocer. Sin embargo, su implementación práctica y estricta en el prototipado nos ha resultado desproporcionada. Llevarlo al máximo nivel de detalle exige una cantidad de tiempo excesiva basada en hacer "clics mecánicos", lo cual deja de aportar valor de aprendizaje real en relación con su impacto en la evaluación. Por una cuestión de eficiencia, decidimos no implementarlo en su totalidad para poder priorizar recursos en fases donde sí había un aprendizaje analítico real.

Conclusión: Nos llevamos una base muy sólida sobre cómo construir productos centrados en el usuario. A pesar de la alta carga de trabajo, terminar con un producto funcional y testeado como Bold Burger, y haber tenido la oportunidad de auditar críticamente a otros compañeros, nos ha dado una perspectiva muy realista de lo que implica el diseño UX/UI en el entorno profesional.
